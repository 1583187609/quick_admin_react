...
module.exports = {
  ...
  rules: {
    ...
    "@typescript-eslint/no-empty-interface": "warn", //定义的ts interface 类型不能为空
    ...
    "vue/multi-word-component-names": "off", // 要求组件名称始终为多个单词命名的
    "vue/v-on-event-hyphenation": "off", // v-on事件名必须使用连字符
