...
export default ({ className = "" }: Props) => {
  ...
  const fields:FieldItem[] = []; // getFields({ getOpts });
  const initVals = {
    listSearch: "搜索列表",
    activeType: 1,
    name: "张三",
  ...
  return (
    <>
      <div className="f-fs-fs mb-16 mt-4 f-0">
        <strong className="f-1 f-c-c">表单可编辑</strong>
        <strong className="f-1 f-c-c">表单只可读</strong>
        <strong className="f-1 f-c-c">表单纯文本</strong>
      </div>
