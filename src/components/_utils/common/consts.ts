...
export const defaultGroupBtnsMaxNum = getExportData(
  3,
  table?.defaultGroupBtnsMaxNum
);
export const defaultFormItemType = getExportData(
  "input",
  form?.defaultFormItemType
);
...
export const isProd = import.meta.env.MODE === "production"; //是否是生产环境，因为import.meta.env.PROD在生产环境中不为true，所以暂时这样处理
export const isDev = import.meta.env.MODE === "development"; //是否是开发环境
